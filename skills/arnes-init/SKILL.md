...
3. **Entrevista mínima para rellenar `AGENTS.md`** (una pregunta a la vez): nombre del
   ...
   **Las dos líneas, y toda la disciplina de redacción, están en UNA sede y no se copian aquí:
   ...
   frase**. **No la reescribas con tus palabras ni la resumas:** dos instrucciones que redactan por
   su cuenta la misma regla acaban diciendo cosas distintas sobre ella, y es el único texto cuya
   **redacción es el control**.
