...
check "D16: matiz no rebaja critico" deny guard-completado.sh "$(emite_edit_real "$PROJ/requirements/REQ-940.md" 'Estado: en-revisión' 'Estado: completado')"
mkreq_r "REQ-941" "no" "pendiente" "pendiente" "ligero (local)"
check "D16: ligero con matiz sigue ligero" allow guard-completado.sh "$(emite_edit_real "$PROJ/requirements/REQ-941.md" 'Estado: en-revisión' 'Estado: completado')"
