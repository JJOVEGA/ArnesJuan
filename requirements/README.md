...
| [REQ-019](REQ-019.md) | El mayor coste fijo de contexto: `AGENTS.md` entra entero en cada subagente. Se adelgaza **moviendo**, no reescribiendo — no se puede perder una regla que nadie borró | `pendiente` | critico | pendiente | pendiente |
...
| [REQ-021](REQ-021.md) | Las tres sondas de medición, escritas una vez: se reconstruyen en cada comisión y dos de tres se rompieron a la primera, una dejando un proceso vivo 3 h 41 min | `pendiente` | critico | pendiente | pendiente |
