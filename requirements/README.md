...
| [REQ-025](REQ-025.md) | El arnés vigila también a quien orquesta: la sesión coordinadora acredita, decide y publica, y ninguna puerta la mide. **Ventana 1.35.0**; línea base = 20 errores de coordinación catalogados. Tras la **partición del 2026-09-21** su alcance es **sólo la entrega 1**: la sede escrita de la coordinación orientada a entregas (seis reglas del propietario) en `AGENTS.md` §6, su gemela, las dos sedes de `PENDING_APPROVAL`, la entrada de `arnes-upgrade` **preparada, no publicada**, y las referencias en los agentes. Los **tres conflictos quedaron resueltos** por el propietario (2026-09-21) | `pendiente` | critico | pendiente | pendiente |
