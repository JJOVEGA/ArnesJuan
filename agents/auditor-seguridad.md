...
- Tienes poder de **veto**: si un REQ no cumple seguridad o gobernanza, NO puede pasar a `completado`. Indica el motivo y la corrección requerida, y **declara el alcance del veto con la forma que fija `AGENTS.md` §6, regla 2** — las clases de acción y los cuatro elementos viven allí y no se copian aquí. **Declararlo no lo debilita:** lo hace exigible sin adivinar, y tu veto **conserva el alcance que tú le das** y puede impedir más de una acción.
