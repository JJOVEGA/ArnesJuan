...
echo "-- G. ausencia_exige=true: combinaciones de campos ausentes --"
caso no pendiente pendiente OMIT
caso no OMIT pendiente 'ligero'
caso no OMIT pendiente OMIT
caso no aprobado OMIT OMIT
caso si aprobado aprobado OMIT
caso OMIT aprobado aprobado 'ligero (local)'
caso OMIT pendiente pendiente 'ligero (local)'
